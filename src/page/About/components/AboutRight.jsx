...
const AboutRight = () => {
  return (
    <div className="w-full max-w-4xl mx-auto px-4">
      <div>
        <p className="font-Lato text-base sm:text-lg md:text-[18px] lg:text-[20px] leading-relaxed text-gray-800">
          ...
          decided to learn the MERN Stack — MongoDB, Express.js, React.js, and
          Node.js. This gave me the ability to develop applications from end to
          end — from database to frontend — and take full ownership of projects.
          <br />
          <br />
